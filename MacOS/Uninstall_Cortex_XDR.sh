...
# Define the location of the Cortex XDR app
XDRPath="/Applications/Cortex XDR Uninstaller.app"

# Obtain the uninstaller password from the console
password="Removal_key"

# Run the uninstaller with the provided removal key 
if "$XDRPath/Contents/Resources/cortex_xdr_uninstaller_tool" "$password"; then
